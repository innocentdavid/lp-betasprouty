...
const VIDEO_TESTIMONIALS = [
  ...
  },
  {
    ...
    fullName: "Miss Switzerland 2023",
  },
  {
    videoUrl: "810138832",
    bg: "/images/vt-3.png",
            ...
            >
              ...
              >
                <div className="relative h-[100px]">
                  <RingSvg />
                  <div className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 z-[1] w-[87px] h-[87px] m-auto">
                    <div className="">
                      <img
                ...
                <div className="text-center mt-4 text-sm font-bold text-white">
                  <div className="">{Vtestimonial.username}</div>

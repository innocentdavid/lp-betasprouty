...
const AnimatedCardV2 = () => {
  ...
  return (
    <div
      className="max-w-[350px] mx-auto bg-[#fafbfc] p-[18px] pt-[14px] flex flex-col gap-[0.5em] border border-[#ebedef] rounded-lg font-dashboard group hover:shadow-[rgba(36,_42,_66,_0.08)_0px_20px_70px_-10px,_rgba(36,_42,_66,_0.04)_0px_10px_24px_-8px,rgba(36,_42,_66,_0.06)_0px_1px_4px_-1px] relative"
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <p className="text-gray-500">
          Easily track your engagement analytics to improve your content and
          grow faster.
        </p>
      </div>
    </div>
